    ...
    <diV class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
      <form action="{{ route('register') }}" method="POST" novalidate>
        ...
        <div class="mb-5">
          ...
          <input id="username" name="username" type="text" placeholder="Tu nombre de usuario" class="w-full border p-3 rounded-lg @error('username') border-red-500 @enderror" value="{{ old('username') }}">
          @error('username')
          <p class="bg-red-500 text-white my-2 rounded text-sm p-2 text-center">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="mb-5">
          ...
          <input id="password" name="password" type="password" placeholder="Password de registro" class="w-full border p-3 rounded-lg @error('password') border-red-500 @enderror">
          @error('password')
          <p class="bg-red-500 text-white my-2 rounded text-sm p-2 text-center">{{ $message }}</p>
          @enderror
        </div>
        <div class="mb-5">
          ...
          <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Password de confirmación" class="w-full border p-3 rounded-lg @error('password_confirmation') border-red-500 @enderror">
        </div>
